...
// 	filename, err := ValidateAndSaveImage(fileHeader, uploadDir)
...
// // Test 2: Valid PNG
// func TestValidateAndSaveImage_ValidPNG(t *testing.T) {
// 	uploadDir := t.TempDir()
...
// 	_, err := ValidateAndSaveImage(fileHeader, uploadDir)
...
// func TestValidateAndSaveImage_FileTooLarge(t *testing.T) {
// 	uploadDir := t.TempDir()
...
// func TestValidateAndSaveImage_PathTraversal(t *testing.T) {
// 	uploadDir := t.TempDir()
...
// func TestValidateAndSaveImage_InvalidFilename(t *testing.T) {
// 	uploadDir := t.TempDir()
...
// func TestValidateAndSaveImage_FakeJPEG(t *testing.T) {
// 	uploadDir := t.TempDir()
...
// func TestValidateAndSaveImage_CorruptedImage(t *testing.T) {
// 	uploadDir := t.TempDir()
